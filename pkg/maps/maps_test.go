...
func TestMapContains(t *testing.T) {
	...
	require.True(t, MapContains(m, "a"), "MapContains(%v, %v) = false, expected true", m, "a")

	// Test case 2: Key is not present
	require.False(t, MapContains(m, "d"), "MapContains(%v, %v) = true, expected false", m, "d")

	// Test case 3: Empty map
	m2 := map[string]int{}
	require.False(t, MapContains(m2, "a"), "MapContains(%v, %v) = true, expected false", m2, "a")
}
